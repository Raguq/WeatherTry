...
translations = {
    ...
    "Fetch Weather": "Получить прогноз погоды",
...
weather_translations = {
    ...
    "Patchy snow nearby": "Возможен кратковременный снег",
    "Patchy sleet nearby": "Возможен кратковременный дождь со снегом",
    "Patchy freezing drizzle nearby": "Возможен кратковременный ледяной дождь",
    "Thundery outbreaks nearby": "Возможны грозовые вспышки",
    "Blowing snow": "Метель",
    "Blizzard": "Буран",
    "Fog": "Туман",
...
def display_weather(weather_data):
    ...
    for i, day in enumerate(weather_data['forecast']['forecastday']):
        ...
        if "rain" in description.lower():
            ...
            weather_frame.configure(bg="red")
